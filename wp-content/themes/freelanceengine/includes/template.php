...
?>
	<# if(post_status == 'pending'){ #>
        <a data-action="edit" data-target="#" class="action edit" href="#edit_place" title="<?php _e('Edit', ET_DOMAIN);?>"><i class="fa fa-pencil"></i></a>
    ...
    <# if(post_status == 'publish'){ #>
        <a data-action="edit" data-target="#" class="action edit" href="#edit_place" title="<?php _e('Edit', ET_DOMAIN);?>"><i class="fa fa-pencil"></i></a>
        <a title="{{= post_views }} <?php _e("views", ET_DOMAIN); ?>" class="post-views" href="#"><i class="fa fa-eye"></i></a>
        <a data-action="archive" class="action archive" href="#" title="<?php _e('Archive', ET_DOMAIN);?>"><i class="fa fa-trash-o"></i></a>
    <# } #>
    ...
    <# if(post_status == 'reject'){ #>
    	<a data-action="edit" data-target="#" class="action edit" title="<?php _e('Edit', ET_DOMAIN);?>" href="#edit_place"><i class="fa fa-pencil"></i></a>
    <# } #>
    <?php
}