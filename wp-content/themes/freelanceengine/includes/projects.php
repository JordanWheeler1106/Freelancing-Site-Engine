...
class Fre_ProjectAction extends AE_PostAction
{
    ...
    */
    public function replace_mail_reject_post($message, $data){
        ...
        $string = "<a href='".$linkProfile."' target='_Blank'>".__('Dashboard', ET_DOMAIN)."</a>";
    ...
    function ae_convert_project($result) {
        ...
        if ($result->post_status == 'disputing') $result->status_text = __("DISPUTING", ET_DOMAIN);

        //project is diputed
        if ($result->post_status == 'disputed') $result->status_text = __("DISPUTED", ET_DOMAIN);
