    ...
    ?>
        <ul class="social-list-footer">
            <?php if( ae_get_option('site_facebook') ) {
                echo '<li class="fre-fb-item"><a target="_blank" href="'. ae_get_option('site_facebook') .'"><span><i class="fa fa-facebook"></i></span>'.__("Facebook", ET_DOMAIN).'</a></li>' ;
            } ?>
            <?php if( ae_get_option('site_twitter') ) {
                echo '<li class="fre-twitter-link"><a target="_blank" href="'. ae_get_option('site_twitter') .'"><span><i class="fa fa-twitter"></i></span>'. __("Twitter", ET_DOMAIN).'</a></li>' ;
            } ?>

            <?php if( ae_get_option('site_google') ) {
                echo '<li class="fre-gp-link"><a target="_blank" href="'. ae_get_option('site_google') .'"><span><i class="fa fa-google-plus"></i></span>'.__("Google+", ET_DOMAIN).'</a></li>' ;
            }
