    	...
    	<div class="container">
        	<div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="single-profile-content">
                        <?php
                        if(fre_share_role() || (ae_user_role($author_id) == FREELANCER && in_array(ae_user_role($user_ID), array(EMPLOYER, 'administrator')))){
                        // if ( (fre_share_role() && in_array(ae_user_role($author_id), array(EMPLOYER, 'administrator')) ) || ae_user_role($author_id) == FREELANCER ){
